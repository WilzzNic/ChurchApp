<div class="row">
    <div class="col-md-3">
        <form action="{{ route('admin.manage.kaj.img', ['id' => $model->id]) }}" method="GET">
    ...
    <div class="col-md-3">
        <form method="post" action="{{ route('admin.manage.kaj.validate', ['id' => $model->id]) }}">
            @csrf
            @method('PUT')
    ...
    <div class="col-md-3">
        <form method="post" action="{{ route('admin.manage.kaj.invalidate', ['id' => $model->id]) }}">
            @csrf
            @method('PUT')
