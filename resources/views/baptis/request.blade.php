                ...
                <div class="card bg-secondary shadow">
                    <div class="card-header bg-white border-0">
                        <div class="row align-items-center">
                            ...
                            <h3 class="text-center col-12 mb-0">{{ __('Pelayanan Baptis') }}</h3>
                        </div>
                    </div>
                    <div class="card-body">
                            ...
                            <div class="pl-lg-4">
                                ...
                                <div class="form-group{{ $errors->has('nama') ? ' has-danger' : '' }}">
                                    ...
                                    class="form-control form-control-alternative{{ $errors->has('nama') ? ' is-invalid' : '' }}"
                                     placeholder="{{ __('Nama') }}" value="{{ old('nama', auth()->user()->name) }}" required>
                                ...
                                <div class="form-group{{ $errors->has('alamat') ? ' has-danger' : '' }}">
                                    ...
                                    rows="3" name="alamat" placeholder="Tulis alamat lengkap di sini..">{{ old('alamat') }}</textarea>
                                ...
                                <div class="form-row">
                                    <div class="col">
                                        ...
                                        <div class="input-group input-group-alternative mb-3">
                                            ...
                                            <input class="form-control{{ $errors->has('tmpt_lhr') ? ' is-invalid' : '' }}" placeholder="{{ __('Tempat Lahir') }}" type="text" id="input-tmpt-lhr" name="tmpt_lhr" value="{{ old('tmpt_lhr') }}" required>
                                        </div>
                                    ...
                                    <div class="col">
                                        ...
                                        <div class="input-group input-group-alternative">
                                            ...
                                            <input class="form-control datepicker" id="input-tgl-lhr" name="tgl_lhr" placeholder="Tanggal Lahir" type="text" value="{{ old('tgl_lhr') }}">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group{{ $errors->has('profesi') ? ' has-danger' : '' }}">
                                    ...
                                    placeholder="{{ __('Profesi') }}" value="{{ old('profesi') }}">
                                ...
                                <div class="form-group{{ $errors->has('nama_ibu') ? ' has-danger' : '' }}">
                                    ...
                                    placeholder="{{ __('Nama Ibu') }}" value="{{ old('nama_ibu') }}">
                                ...
                                <div class="form-group{{ $errors->has('nama_ayah') ? ' has-danger' : '' }}">
                                    ...
                                    placeholder="{{ __('Nama Ayah') }}" value="{{ old('nama_ayah') }}">
                                ...
                                {{-- <div class="form-group">
                                    <a class="thumbnail">
                                        <img alt="KAJ Picture" id="img_kaj">
                                    </a>
                                    <div class="custom-file">
                                        <label class="custom-file-label" for="kajFile">Upload KAJ</label>
