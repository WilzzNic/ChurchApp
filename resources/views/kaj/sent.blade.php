...
'description' => __('Ini adalah halaman detil pengajuan KAJ Anda.'),
'class' => 'col-lg-12'
])
            ...
            <div class="card bg-secondary shadow">
                <div class="card-header bg-white border-0">
                    <div class="row align-items-center">
                        ...
                        <p class="text-muted text-center col-12 mb-0">Di bawah merupakan status permohonan KAJ Anda.</p>
                    </div>
                </div>
                <div class="card-body">
                    <form method="POST" action="{{ route('bcon.requestkaj.delete', ['id' => $request->id]) }}">
                        @csrf
                        @method('DELETE')
                            ...
                            <div class="col">
                                ...
                                <div class="alert alert-success" role="alert">
                                    ...
                                    <span class="alert-inner--text"><strong>Permohonan anda ditolak</strong>
                                        Silakan mengajukan kembali permohonan KAJ.</span>
                                </div>
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            <label for="staticTanggal" class="col-sm-2 col-form-label">Tanggal Permohonan:</label>
                            <div class="col-sm-10">
